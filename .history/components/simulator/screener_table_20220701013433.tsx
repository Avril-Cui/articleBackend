...
const ScreenerTable = () => {
    ...
    }, [stock_wrkn_price, stock_sgo_price, stock_fsin_price, stock_hhw_price, stock_dsc_price, stock_ast_price, stock_jky_price, stock_wrkn_change, stock_sgo_change, stock_fsin_change, stock_hhw_change, stock_dsc_change, stock_ast_change, stock_jky_change, price_wrkn_change, price_sgo_change, price_fsin_change, price_hhw_change, price_dsc_change, price_ast_change, price_jky_change]);
