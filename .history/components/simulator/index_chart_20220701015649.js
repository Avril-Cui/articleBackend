...
import simulated_price from "../../price_info/simulated_price.json";
...
const IndexChart = () => {
  ...
  return (
    <ReactEcharts  style={{height: 325, width: 500,marginTop: -50, marginLeft: -5}} option={option} />
  );
};
