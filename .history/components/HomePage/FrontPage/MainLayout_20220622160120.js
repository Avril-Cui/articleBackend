      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-6 p-2 md:p-6">
        <Link href="/news">
          <div className={styles.img_border}>
            <div className={styles.img}><Image src={picture} alt="" height={700}/></div>
        ...
        <Link href="/model">
          <div className={styles.img_border}>
          <div className={styles.img}><Image src={model} alt="" height={700}/></div>
            <div className={styles.text_cont}>
        ...
        <Link href="/simulator">
          <div className={styles.img_border}>
          <div className={styles.img}><Image src={simulator} alt="" height={700}/></div>
            <div className={styles.text_cont}>
