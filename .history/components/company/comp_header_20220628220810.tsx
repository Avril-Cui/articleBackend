...
let raw_data = require('json-loader!/Users/xiaokeai/Desktop/aspect_website/price_info/wrkn/second.json');
...
export const getStockData = () =>{
  ...
  useEffect(() => {
    const data = setInterval(() => {
      let string_data = `/Users/xiaokeai/Desktop/aspect_website/price_info/wrkn/second.json`
      fetch('/api/getPrice', {
