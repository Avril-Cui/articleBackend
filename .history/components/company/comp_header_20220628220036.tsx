...
export const getStockData = () =>{
  ...
  useEffect(() => {
    const data = setInterval(() => {
      // let priceData= require("/Users/xiaokeai/Desktop/aspect_website/price_info/wrkn/second.json"); 
      fetch("/Users/xiaokeai/Desktop/aspect_website/price_info/wrkn/second.json")
      .then(response => {
        return response.json();
      })
      .then(jsondata => fetch('/api/getPrice', {
        body: jsondata,
        method: "POST",
      })
      .then((res) => res.json())
