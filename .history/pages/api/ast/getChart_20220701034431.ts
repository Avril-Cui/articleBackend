...
{  
    ...
    try {
        ...
        if (running_time < open_length){
          ...
          const url = 'https://raw.githubusercontent.com/Avril-Cui/articleBackend/main/price_info/ast/inner_day.json?token=GHSAT0AAAAAABVTNMA656CD2CVY2OMA22OEYV57VKA'
