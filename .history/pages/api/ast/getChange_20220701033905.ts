...
{  
    ...
    try {
        ...
        if (running_time < open_length){
          ...
          const file_data = await fsp.readFile("https://raw.githubusercontent.com/Avril-Cui/articleBackend/main/price_info/ast/second.json?token=GHSAT0AAAAAABVTNMA7X7RIGZFJJDEXPHU2YV57QEA")
          const json_data = JSON.parse(file_data)
          value = round(json_data[index])
          change = round((value-json_data[0])/json_data[0]*100)
