  ...
  return (
    <div>
      ...
      <TermsSection
        ...
        section_name="DCF"
        intro_text="This section introduces the classical Discounted Cash Flow Model (DCF). DCF commonly used in fundamental valuation approach and it looks for the 'intrinsic' value of companies. The model is built based on the Time Value of Money (TVM) theory, so we will start up this section by learning the TVM. Then, different components inside DCF will be introduced. By the end of this section, you will be able to construct your own DCF model using Excel."
