...
export default function Wakron({ invididual }: Props ) {  
  return (
    <div className={styles.container}>
      {invididual.map((company: any) => (
        <div key={`${company.id}`}>
          <CompHeader CompanyName={company.id} CompanyShortName={company.short_name} CompanyFullName={company.name}/>
          <div className={styles.price_chart}>
            <p className={styles.price_text}>Price Chart</p>
            <div>
              {/* <WrknChart DataSource={company.inner_day_source}/> */}
            </div>
          </div>
          ...
          <div className={styles.day_chart}>
            {/* <WrknDayChart simulated_price={company.tick_source}/>   */}
          </div>
...
export const getStaticProps: GetStaticProps = async ({ params }) => {
  ...
  const invididual = companies.map((company: any) => ({
    id: company.id,
    short_name: company.short_name,
    name: company.name,
    overview: company.overview,
    day_source: company.day_source,
    inner_day_source: company.inner_day_source,
    second_source: company.second_source,
    tick_source: company.tick_source,
    news_type: company.news_type
  }));
