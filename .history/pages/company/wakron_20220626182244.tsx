  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.comp_overview}>
        <p className={styles.price_text}>Company Overview</p>
        <p className={styles.comp_description}>
          ...
          a software for business and project teams to manage their projects;
          Wakron Pay, a digital payment application enabling online transactions
          for consumers and merchants worldwide. Starting in 2019, Wakron
          started to extend its business toward the gaming industry. Until 2022,
          it promoted over ten hype-game, including WraX — a multiplayer
          survival battle game, and Kroon — an augmented reality-based
          interacting game.
        </p>
      </div>
