import WrknChart from "../../components/company/wrknChart";
...
import IndividualNews from "../../components/company/individual_news";
  ...
  return (
    <div className={styles.container}>
        <div key={individual.id}>
          <CompHeader CompanyName={individual.id} CompanyShortName={individual.short_name} CompanyFullName={individual.name}/>
          <div className={styles.price_chart}>
            <p className={styles.price_text}>Price Chart</p>
            <div>
              <WrknChart CompanyName={individual.id}/>
            </div>
          </div>
          ...
          <div className={styles.day_chart}>
            <p className={styles.major_price_chart}>Stock Price Chart</p>
          ...
          <p className={styles.news_heading}>Company News</p>
          {posts.map((post) => (
  ...
  const companies = [
    {
      ...
      news_type: "d8488564-bc41-4874-a820-9ac245c07af"
    },
    {
      id: "hhw",
      short_name: "W",
